...
@Component({
  selector: 'app-download-corporate-card',
  templateUrl: './download-corporate-card.component.html',
  styleUrls: ['./download-corporate-card.component.css']
})
export class DownloadCorporateCardComponent implements OnInit {
